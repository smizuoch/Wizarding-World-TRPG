...
const SKILL_GROUPS = [
  {
    ...
    skills: [
      ...
      createSkill('法律', 5),
      createSkill('歴史', 5),
      createSkill('サバイバル', 10, { locked: false }),
    ],
  },
  {
    id: 'magic',
    label: '魔法技能',
    skills: [
      createSkill('撃て（フリペンド）', 50),
      createSkill('目くらまし術', 20),
      createSkill('開け（アロホモラ）', 5),
      createSkill('閉まれ（コロポータス）', 5),
      ...
      createSkill('癒えよ（エピスキー）', 30),
      createSkill('直れ（レパロ）', 25),
      createSkill('開心（レジリメンス）', 1),
      createSkill('暴け（レベリオ）', 25),
      createSkill('弾け（インパービアス）', 10),
      createSkill('守護霊よ来たれ', 1),
      createSkill('武器よ去れ（エクスペリアームス）', 20),
      createSkill('麻痺せよ（ステューピファイ）', 10),
      createSkill('活きよ（エネルベート）', 10),
